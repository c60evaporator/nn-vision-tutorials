...
PRETRAINED_WEIGHT = '/scripts/pretrained_weights/segmentation/sam_vit_h_4b8939.pth'  # Model Checkpoint download from (https://github.com/facebookresearch/segment-anything?tab=readme-ov-file#model-checkpoints)
