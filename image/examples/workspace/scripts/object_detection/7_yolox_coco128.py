...
EXP_SCRIPT_PATH = '/workspace/scripts/object_detection/configs/yolox_exp_train.py'  # Exp file path (https://github.com/Megvii-BaseDetection/YOLOX/blob/main/docs/train_custom_data.md#2-create-your-exp-file-to-control-everything)
TRAIN_SCRIPT_PATH = 'tools/train.py'  # Training script path (relative path from YOLOX_ROOT)
PRETRAINED_WEIGHT = '/workspace/pretrained_weights/object_detection/yolox_s.pth'  # Pretrained weight for YOLOX (Download from https://github.com/Megvii-BaseDetection/YOLOX/tree/main?tab=readme-ov-file#benchmark)
...
# best_weights = torch.load(f'/workspace/examples/pretrained_weights/yolox_s.pth')
