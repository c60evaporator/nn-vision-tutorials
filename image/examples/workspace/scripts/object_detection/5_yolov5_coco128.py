...
PRETRAINED_WEIGHT = '/workspace/pretrained_weights/object_detection/yolov5m.pt'  # Pretrained weight for YOLOv5 (Download from https://github.com/ultralytics/yolov5#pretrained-checkpoints)
