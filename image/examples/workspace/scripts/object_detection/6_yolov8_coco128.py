...
MODEL_YAML_URL = '/workspace/scripts/object_detection/configs/yolov8.yaml'  # YOLOv8 Model yaml file (Download from https://github.com/ultralytics/ultralytics/tree/main/ultralytics/cfg/models/v8)
