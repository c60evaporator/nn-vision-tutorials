...
# Recommended resize_size=520 but other size is available (https://pytorch.org/vision/main/models/generated/torchvision.models.segmentation.deeplabv3_resnet50.html)
...
torch.save(params, f'{PARAMS_SAVE_ROOT}/vocseg_deeplabv3_resnet50.prm')


# %%
###### Inference in the first mini-batch ######
# Reload parameters
params_load = torch.load(f'{PARAMS_SAVE_ROOT}/vocseg_deeplabv3_resnet50.prm')
