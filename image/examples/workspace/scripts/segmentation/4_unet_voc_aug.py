# %% Pascal VOC Segmentation + UNet by smp (ResNet34) + Data Augumentation by Albumentations (https://github.com/qubvel/segmentation_models.pytorch/blob/master/examples/cars%20segmentation%20(camvid).ipynb)
import torch
...
PARAMS_SAVE_ROOT = '/workspace/params/segmentation'  # Directory for Saved parameters
...
torch.save(params, f'{PARAMS_SAVE_ROOT}/vocseg_unet_{ENCODER}_aug.prm')

###### Inference in the first mini-batch ######
# Reload parameters
params_load = torch.load(f'{PARAMS_SAVE_ROOT}/vocseg_unet_{ENCODER}_aug.prm')
