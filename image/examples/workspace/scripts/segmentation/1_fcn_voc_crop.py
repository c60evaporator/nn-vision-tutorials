...
albumentations_transform = A.Compose([
    A.RandomCrop(height=112, width=112, always_apply=True),  # Applied to both image and mask
...
torch.save(params, f'{PARAMS_SAVE_ROOT}/vocseg_fcn_resnet50_crop.prm')


# %%
###### Inference in the first mini-batch ######
# Reload parameters
params_load = torch.load(f'{PARAMS_SAVE_ROOT}/vocseg_fcn_resnet50_crop.prm')
